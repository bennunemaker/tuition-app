  ...
  methods: {
    saveModal() {
      ...
      if (this.employee) {
        ...
        if (this.employee.hireDate)
          employee.hireDate = this.employee.hireDate.trim();
    ...
    validateInput(employee) {
      ...
      if (
        ...
        employee.name.length > stringLimit
      )
      ...
      if (
        employee.hireDate &&
        employee.hireDate.length &&
        employee.hireDate.length > dateLimit
      )
        errors.push("Hire Date is Longer Than " + dateLimit + " Characters");
